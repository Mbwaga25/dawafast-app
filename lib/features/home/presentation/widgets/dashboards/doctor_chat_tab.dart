...
class DoctorChatTab extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DoctorChatTab> createState() => _DoctorChatTabState();
}
...
class _DoctorChatTabState extends ConsumerState<DoctorChatTab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Direct Messaging', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Start a conversation with anyone', style: TextStyle(color: Colors.grey[500], fontSize: 16)),
                      ],
                    ),
                  )
                : ListView.builder(
